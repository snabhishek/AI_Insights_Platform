...
const ToastCard = ({
  ...
  const messageText = toast.title || toast.message || "";

  return (
    <div
      className={`relative overflow-hidden rounded-xl border backdrop-blur-xl shadow-xl transition-all duration-300 transform translate-x-0 opacity-100 flex flex-col p-3 pointer-events-auto min-w-[280px] max-w-[380px] ${style.wrapper}`}
      style={{
